...
| `async execute_many_async(requests) -> list[ToolExecutionResult]` | Run structured tool requests concurrently; results preserve request order and isolate failures. |
